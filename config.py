# Enter Your API Key here from https://wallhaven.cc/settings/account, will need to create an account first
ApiKey="" 

# Enter a search query/tag here to fetch wallpapers from
Query="" 

# 100* /110/111/etc (sfw/sketchy/nsfw) Turn purities on(1) or off(0) 
